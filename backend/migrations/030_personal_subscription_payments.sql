...
CREATE TABLE personal_subscription_payments (
...
CREATE INDEX idx_personal_subscription_payments_pending ON personal_subscription_payments(submitted_at) WHERE status = 'pending';
