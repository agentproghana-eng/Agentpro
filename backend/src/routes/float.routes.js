...
router.get('/history/cursor', authorize('superuser', 'business_owner', 'manager', 'auditor'), floatController.getFloatHistoryCursor);
...
router.get('/requests/cursor', authorize('business_owner', 'manager', 'agent'), floatController.listFloatRequestsCursor);
