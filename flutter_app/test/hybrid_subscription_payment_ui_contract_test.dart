...
void main() {
  group(
    'Hybrid subscription payment UI contracts',
    () {
      test(
      ...
      test(
        'captured stale payments are a terminal reconciliation state',
        () {
          for (final path in [
            'lib/features/subscription/'
                'subscription_screen.dart',
            ...
            expect(
              source,
              contains(
                'No extra subscription period was added.',
              ),
            );
      ...
      test(
        'no Flutter subscription file contains a Paystack server secret',
        () {
          for (final path in [
            'lib/features/subscription/'
                'subscription_payment_service.dart',
