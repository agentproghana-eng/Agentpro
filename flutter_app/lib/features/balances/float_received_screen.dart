    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: ListView(children: [
          ...
          Row(children: [
            _ProviderPill(label: "MTN", value: "mtn", selected: _provider == "mtn", color: AppTheme.providerColor("mtn"), onTap: (v) => setState(() => _provider = v)),
            const SizedBox(width: 6),
            _ProviderPill(label: "Telecel", value: "telecel", selected: _provider == "telecel", color: AppTheme.providerColor("telecel"), onTap: (v) => setState(() => _provider = v)),
            const SizedBox(width: 6),
            _ProviderPill(label: "AirtelTigo", value: "at_money", selected: _provider == "at_money", color: AppTheme.providerColor("at_money"), onTap: (v) => setState(() => _provider = v)),
          ]),
