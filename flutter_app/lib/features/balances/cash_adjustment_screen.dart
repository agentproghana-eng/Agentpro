    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: ListView(children: [
          Row(children: [
            Expanded(
                child: _ModeTab(
                    ...
                    selected: isSetValue,
                    onTap: () => setState(() {
                          _mode = _AdjMode.setValue;
                          _error = null;
                        }))),
            const SizedBox(width: 6),
            Expanded(
                child: _ModeTab(
                    label: 'Injection / Withdrawal',
                    selected: !isSetValue,
                    onTap: () => setState(() {
                          _mode = _AdjMode.injection;
                          _error = null;
          ...
          if (isSetValue) ...[
            const Text('Current Cash at Hand Is',
            ...
            TextField(
                ...
                decoration: const InputDecoration(
                    prefixText: 'GH₵ ', border: OutlineInputBorder())),
            ...
            Container(
              ...
              child: Text(
                  'This takes effect immediately — a routine count, no approval needed.',
                  style: TextStyle(
                      fontSize: 11,
            ...
            Row(children: [
              Expanded(
                  child: _TypeChip(
                      label: 'Injection (+)',
                      selected: _mode == _AdjMode.injection,
                      onTap: () => setState(() => _mode = _AdjMode.injection))),
              const SizedBox(width: 8),
              Expanded(
                  child: _TypeChip(
                      label: 'Withdrawal (−)',
                      selected: _mode == _AdjMode.withdrawal,
                      onTap: () =>
                          setState(() => _mode = _AdjMode.withdrawal))),
            ]),
            const SizedBox(height: 16),
            const Text('Amount',
                style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12)),
            ...
            TextField(
                ...
                decoration: const InputDecoration(
                    hintText: 'e.g. added my own cash for change',
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(10)),
              child: Text(
                  "This needs approval from your manager or business owner before it takes effect. Your balance won't change until then.",
                  style: TextStyle(
                      fontSize: 11,
                      color: context.isDarkMode
          ...
          ElevatedButton(
            ...
            child: _loading
                ...
                : Text(
                    isSetValue ? 'Update Cash at Hand' : 'Submit for Approval'),
          ),
        ]),
      ),
    );
