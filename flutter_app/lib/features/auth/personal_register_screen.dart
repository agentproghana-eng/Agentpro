          ...
          builder: (context, state) {
            ...
            return Form(
              ...
              child: ListView(
                ...
                children: [
                  const Text('Create your Personal account', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                  const SizedBox(height: 4),
                  const Text('Free to start. No business registration or approval needed.',
                  ...
                  AppButton(label: 'Create Account', onPressed: _submit, isLoading: loading),
                ],
              ),
            );
          },
