      ...
      body: ListView(padding: const EdgeInsets.all(16), children: [
            ...
            child: Row(children: [
              ...
              Expanded(
                  child: Column(
                    ...
                    Text(
                        'Step-by-step help for every feature - works offline, always free',
                        style: TextStyle(
                            fontSize: 11.5, color: context.appSecondaryText)),
                  ])),
        ...
        Container(
          ...
          child:
            ...
            const Text('Call Your Network',
                style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
            Text('For PIN issues and account problems',
                style:
                    TextStyle(fontSize: 11, color: context.appSecondaryText)),
        ...
        Container(
          ...
          child:
            ...
            const Text('App Support',
                style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
            Text('For questions about Agent Pro Ghana itself',
                style:
                    TextStyle(fontSize: 11, color: context.appSecondaryText)),
            const SizedBox(height: 10),
            InkWell(
              ...
              child: const Row(children: [
                ...
                SizedBox(width: 8),
                Text('support@agentproghana.com',
                    style:
